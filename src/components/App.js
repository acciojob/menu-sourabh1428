...
function App() {
    ...
    const data=[
      ...
      function allClick(){
        setDish(data.filter((e)=>e.category!==''));
      }
      function breakClick(){
        setDish(data.filter((e)=>e.category=='breakfast'));
      }
      function lunchClick(){
        setDish(data.filter((e)=>e.category=='lunch'));
      }
      function shakeClick(){
        setDish(data.filter((e)=>e.category=='shakes'));
      }
